        ...
        <div className="App">
            <nav className="main-nav">
                ...
                <ExportMenu
                    ...
                    rawData={story}
                    type="story"
                    targetId="printable-story-area"
                />
            </nav>

            {/* --- NEW PROFILE HEADER LAYOUT --- */}
            <div id="printable-story-area">
                    ...
                    <div className="profile-image-container">
                        {editingField === 'image' ? (
                            <div className="inline-edit-group" style={{flexDirection: 'column'}}>
                                ...
                                {editStoryData.image_url && <img src={editStoryData.image_url} alt="Preview"
                            ...
                            <div className="profile-image-display" onClick={() => setEditingField('image')}
                                 title="Click to edit illustration">
                                {story.image_url ? (
                                    <img src={story.image_url} alt={story.title}/>
                                ) : (
                                    <div className="profile-image-placeholder"
                                         style={{textAlign: 'center', padding: '1rem'}}>No Illustration</div>
                                )}
                    ...
                    <div className="profile-identity">
                        ...
                        {editingField === 'date' ? (
                            <div className="inline-edit-group date-edit">
                                <input type="text" value={editStoryData.publication_date}
                                       onChange={(e) => setEditStoryData({
                                           ...editStoryData,
                                           publication_date: e.target.value
                                       })} placeholder="e.g., c. 2100 BCE" maxLength={100}/>
                                <button onClick={handleSaveStoryDetail} className="edit-button">Save</button>
                            </div>
                        ) : (
                            ...
                            {!isAddingTag ? (
                                ...
                                <form onSubmit={handleAddTag} className="add-tag-form" style={{margin: 0}}>
                                    ...
                                    <button type="button" className="toggle-button"
                                            ...
                                            onClick={() => setIsAddingTag(false)}>Cancel
                                    </button>
                                </form>
                            )}
                        </div>
                        ...
                        <div style={{
                            ...
                            {editingField === 'synopsis' ? (
                                <div className="inline-edit-group synopsis-edit">
                                    <textarea value={editStoryData.synopsis} onChange={(e) => setEditStoryData({
                                        ...editStoryData,
                                        synopsis: e.target.value
                                    })} autoFocus placeholder="Enter a brief synopsis..." maxLength={1000}/>
                                ...
                                <div className="editable-field story-synopsis preamble"
                                    ...
                                    <p style={{
                                        ...
                                        margin: 0,
                                        width: '100%'
                                    }}>{story.synopsis || "No synopsis available."}</p>
                                    <button className="inline-edit-icon" onClick={() => setEditingField('synopsis')}
                                            title="Edit Synopsis"
                                            style={{alignSelf: 'flex-start', marginTop: '5px'}}>&#x270E;</button>
                                </div>
                            )}
                        </div>
                            ...
                            <div className="story-body-display">
                                <div className="story-text">
                                    {story.content ? (
                                        ...
                                        <p className="empty-content">Click "Edit Tale" to begin chronicling this
                                            story...</p>
                                    )}
                                </div>
                            </div>
                ...
                {!isAdding ? (
                    ...
                    <div className="character-card edit-mode" style={{justifyContent: 'center', overflow: 'visible'}}>
                        <form onSubmit={handleAttachSubmit}
                            ...
                            <input type="text" placeholder="Role in story (Max 100 chars)" value={newCharRole}
                                   onChange={(e) => setNewCharRole(e.target.value)} maxLength={100}/>
